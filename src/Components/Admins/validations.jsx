...
export const schema = Joi.object({
  ...
  dni: Joi.number().min(100000).max(999999999999999).required().messages({
    'number.base': 'DNI must be a number.',
    'number.min': 'DNI must be at least 6 numbers long.',
    'number.max': 'DNI must be no longer than 15 numbers.',
    'number.unsafe': 'DNI must be no longer than 15 numbers.',
